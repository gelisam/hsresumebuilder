...
data Preferences = Preferences
  { personal :: PersonalInfo,
    ...
    aiProjects :: [SingleItem],
    programmingLanguageProjects :: [SingleItem],
    theoremProverProjects :: [SingleItem],
...
data DocumentTitles = DocumentTitles
  { shortIntroTitle :: String,
    ...
    programmingLanguageProjectsTitle :: String,
    theoremProverProjectsTitle :: String,
